...
class Ec2LaunchTemplateFieldsIntegrationTest {
    ...
    void networkInterfacesSurviveAsNetworkInterfacesInsteadOfBeingPromoted() {
        ...
        describeLatest(name)
            ...
            .body(DATA + "networkInterfaceSet.item.groupSet.groupId",
        ...
        // The top-level set is emitted, but empty (lex00/floci#123).
        assertFalse(describeBody(name).contains("<securityGroupIdSet><item>"),
