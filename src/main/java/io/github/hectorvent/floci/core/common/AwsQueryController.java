...
public class AwsQueryController {
    ...
    private static final Set<String> EC2_ACTIONS = Set.of(
            ...
            "CreateTransitGateway", "DescribeTransitGateways", "ModifyTransitGateway", "DeleteTransitGateway",
            "CreateTransitGatewayVpcAttachment", "DescribeTransitGatewayVpcAttachments",
            "ModifyTransitGatewayVpcAttachment", "DeleteTransitGatewayVpcAttachment",
            "CreateTransitGatewayRouteTable", "DescribeTransitGatewayRouteTables",
            "DeleteTransitGatewayRouteTable",
            "CreateTransitGatewayRoute", "DeleteTransitGatewayRoute", "SearchTransitGatewayRoutes",
            "AssociateTransitGatewayRouteTable", "DisassociateTransitGatewayRouteTable",
            "EnableTransitGatewayRouteTablePropagation", "DisableTransitGatewayRouteTablePropagation",
    ...
    private static final Set<String> CLOUDWATCH_ACTIONS = Set.of(
            ...
            "PutInsightRule", "DescribeInsightRules", "DeleteInsightRules",
            "EnableInsightRules", "DisableInsightRules"
    );
