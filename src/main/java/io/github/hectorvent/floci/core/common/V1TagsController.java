 ...
 */
// Class-level @Path is "/" with the /v1/tags prefix folded into each method: a literal
// class-level @Path("/v1/tags") would own the exact /v1/tags path too, shadowing services
// (CodeArtifact) that serve query-parameter tag endpoints at that literal path.
@Path("/")
